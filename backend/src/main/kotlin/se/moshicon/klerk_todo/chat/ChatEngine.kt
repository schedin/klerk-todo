            ...
            messages.add(
                ChatCompletionMessageParam.ofSystem(ChatCompletionSystemMessageParam.builder()
                    .content("""You are a helpful assistant that can manage TODO items in a web based TODO application.
                        ...
                        The user is logged in as the username "${chatSession.userId}" with the pretty name "${chatSession.userName}". Only use the pretty name for display purposes, and user the username for tool invocations.
